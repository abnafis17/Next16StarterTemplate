...
// Table component
const Table = React.forwardRef<HTMLTableElement, TableElementProps<HTMLTableElement>>(
  ({ className, ...props }, ref) => (
    <div className="relative w-full overflow-auto modal-scroll rounded-md">
      <table
        ref={ref}
        className={cn(
...
const TableRow = React.forwardRef<HTMLTableRowElement, TableElementProps<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
...
const TableHead = React.forwardRef<HTMLTableCellElement, TableElementProps<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn('text-[12px] bg-slate-100/50 font-medium dark:bg-slate-800/50', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn('mt-4 text-[12px] text-slate-500 dark:text-slate-400', className)}
    {...props}
  />
));
